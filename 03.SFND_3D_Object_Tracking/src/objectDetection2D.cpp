...
// detects objects in an image using the YOLO library and a set of pre-trained objects from the
// COCO database; a set of 80 classes is listed in "coco.names" and pre-trained weights are stored
// in "yolov3.weights"
void detectObjects(
    cv::Mat &img,
